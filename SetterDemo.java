...
public class SetterDemo {
	...
	private int x;	
	/* recall that if we do not declare a constructor with parameters within a class, we have the option to not declare any constructors
	 because the java compiler adds the default constructor (i.e. the constructor without any parameters) only when we do not declare any constructors within a class */
